/*
    ...
    METODO 4 OBTENER PRODUCTOS MÁS VENDIDOS
...
del mes seleccionado.
    ...
    - Consultar los productos que han sido vendidos.
    - Calcular la cantidad total vendida de cada producto.
    - Calcular el dinero total generado por cada producto.
    - Ordenar los resultados desde el producto más vendido hasta el menos vendido.
    ...
    Devuelve una lista con todos los productos vendidos,
    incluyendo:
    ...
    Declarar los objetos necesarios para ejecutar la consulta.
         */
        PreparedStatement consultaPreparada = null;
    ...
    Crear la lista donde se almacenarán los productos encontrados.

    ArrayList permitirá guardar varios objetos ProductoMasVendido.
         */
        List<ProductoMasVendido> listaProductosMasVendidos = new ArrayList<>();
    ...
    La consulta realizará:

    - JOIN entre productos.
    - detallepedido.
    - pedidos.
    - facturas.
    ...
    Finalmente ordenará los resultados desde el más vendido hasta el menos vendido.
         */
        String consultaSQL = """
            SELECT
        ...
        try {
            ...
            while (resultadoConsulta.next()) {
                ...
                listaProductosMasVendidos.add(productoActual);
            }
        } catch (Exception error) {
            ...
            /*
        PASO 8 Cerrar todos los recursos.
             */
            try {
                if (resultadoConsulta != null) {
                    resultadoConsulta.close();
        ...
        /*
    PASO 9 Devolver la lista completa de productos.
         */
